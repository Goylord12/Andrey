...
public class Sort {
    ...
    public void BubbleSortVisual(Float[] array) {
...
//                stringArray += ", ";
//                visualArray.secondArray.setText(stringArray);
//            }
...
//            VisualArray.isSorted = false;

    }

    public void InsertionSortVisual(Float[] array){
        ArrayList<String> list = new ArrayList<>();
        ArrayList<Timeline> timelines = new ArrayList<>();
