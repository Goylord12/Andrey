...
public class MainWindow {
    ...
    @FXML
    void OnButtonMerge(ActionEvent event) {
    ...
    @FXML
    void OnButtonSort(ActionEvent event) {
    ...
    @FXML
    void onFirstVisual(MouseEvent event) {
        try {
            Sort.stringArray = "";
...
//            VisualArray = new VisualArray(firstArrayVisual, FirstArray.getText());
    ...
    @FXML
    void onMergeVisual(MouseEvent event) {
        try {
            Sort.stringArray = "";
    ...
    @FXML
    void onSecondVisual(MouseEvent event) {
        try {
            Sort.stringArray = "";
